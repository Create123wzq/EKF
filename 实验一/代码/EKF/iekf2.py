...
import numpy as np
import math
from EKF.tinyiekf2 import IEKF2
from EKF.utils import fromCameraToImage, draw, drawQuaternions, getImagePosition, getQuaternion


DELAY_MSEC = 0.01  # 卡尔曼滤波计算时间间隔,单位为s
F = 36 # 焦距 mm
...
class iEKF(IEKF2):
    ...
    def __init__(self, s0, q0, points0, w0, v0, p, q, r, delta):
        IEKF2.__init__(self, 3*M+12, 2*M, pval=p, qval=q, rval=r, delta=delta)
        #初始状态估计
...
#     s0 = [100., 0, 4101.839]
#     s0 = [100., 0, 1980.198]
#     # 初值:小行星坐标系到相机坐标系坐标系旋转矩阵(四元数)(q1, q3值要取反！！！！！！！！！！)
...
#     v0 = [0., 2., 0.]
#
#     # kalfilt = TrackerEKF(s0, q0, points, w0, v0,  p=20, q=0.0001, r=0.000002)
#     kalfilt = iEKF(s0, q0, points, w0, v0, p=0.2,  q=0.0002, r=0.0000002, delta=0.01)
#
...
if __name__ == '__main__':
    ...
    kalfilt = iEKF(s0, q0, points, w0, v0, p=0.02, q=0.0002, r=0.0000002, delta=0.0001)
