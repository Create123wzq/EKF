...
import numpy as np
import math
from EKF.tinyiekf import IEKF
from EKF.utils import fromCameraToImage, draw, drawQuaternions
...
class iEKF(IEKF):
    ...
    def __init__(self, s0, q0, points0, w0, v0, p, q, r, delta):
        IEKF.__init__(self, 3*M+12, 2*M, pval=p, qval=q, rval=r, delta=delta)
        #初始状态估计
...
if __name__ == '__main__':
    ...
    # kalfilt = iEKF(s0, q0, points, w0, v0, p=0.2,  q=0.002, r=0.000002, delta=0.000001)
    kalfilt = iEKF(s0, q0, points, w0, v0, p=0.2, q=0.002, r=0.000002, delta=0.00000001)
